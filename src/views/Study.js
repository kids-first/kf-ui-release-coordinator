...
class Study extends Component {
  ...
  componentWillMount() {
    axios.all([axios.get(`${coordinatorApi}/studies/${this.props.match.params.studyId}/releases`),
               axios.get(`${coordinatorApi}/studies/${this.props.match.params.studyId}`)])
         .then(axios.spread((releases, study) => {
            this.setState({
              study: study.data,
